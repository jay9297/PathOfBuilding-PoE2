...
function ItemSetListClass:CreateItemSet()
	...
	controls.save = new("ButtonControl", nil, { -45, 70, 80, 20 }, "Save", function()
		...
		local existing = {}
		for _, id in ipairs(self.itemsTab.itemSetOrderList) do
			t_insert(existing, self.itemsTab.itemSets[id])
		end
		local newSet = self.itemSetService:NewItemSet(controls.edit.buf)
